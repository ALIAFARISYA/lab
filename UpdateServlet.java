...
public class UpdateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        User existingUser = userDAO.selectUser(id);  // Call DAO
        
        if (existingUser != null) {
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head><title>Update User (Using DAO)</title></head>");
            out.println("<body>");
            out.println("<h2>Update User (Using DAO Pattern)</h2>");
            ...
            out.println("</form>");
            out.println("<br><a href='ViewServlet'>Back to User List</a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        userDAO.updateUser(user);  // Call DAO
